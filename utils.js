 ...
 */
export async function matchKeyword(page, keyword) {
  try {
 ...
 */
export async function getHtmlContent(page, selector) {
 ...
 */
export function getHtmlFromSelector(selector) {
 ...
 */
export async function findNextUrl(page, selector) {
 ...
 */
export function getUrlFromSelector(selector) {
  const element = document.querySelector(selector);
  if (element) {
 ...
 */
export async function getCoverImage(page, url) {
 ...
 */
export function generateTocHtml(headers) {
 ...
 */
export function removeElementFromSelector(selector) {
